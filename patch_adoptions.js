...
let code = fs.readFileSync('src/pages/Adoptions.tsx', 'utf8');
...
code = code.replace(
  "const filtered = selectedProvince === 'Toutes' ? mockAdoptions : mockAdoptions.filter(d => d.province === selectedProvince);",
...
fs.writeFileSync('src/pages/Adoptions.tsx', code);
